...
export function WhatsappWidget() {
  ...
  return (
    <>
      <Script
        src="https://cdn.jsdelivr.net/gh/sanjeevrae/Free-Whatsapp-Widgets-@main/widget.js"
        strategy="afterInteractive"
      />
      <button id="wa-launcher" aria-label="Open WhatsApp chat">
      ...
      <div id="wa-chat">
        <div id="wa-header">
          ...
          <button id="wa-close" aria-label="Close">
            &times;
          </button>
        </div>
        <div id="wa-body">
