  ...
  return (
    <div>
      <div className="pb-4 pt-20">
        ...
        <h1 className="mt-4 text-5xl font-semibold tracking-tight text-[#2c1a7a]">From tap to customer, in three steps</h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
          Chitra Tap turns a simple tap or scan into a complete digital introduction of your business — no app, no printing costs, no outdated brochures.
        </p>
      </div>
      <WorkRow
        id="nfc-qr"
