...
// Free success chime generated with the Web Audio API — no audio file needed.
function playSuccessSound() {
  try {
    ...
    // Sound is best-effort only; never block the UI.
  }
}
...
Ready to get your ChitraTap?              </h2>
              <p className="mt-2 max-w-2xl text-xs leading-5 text-[#5f6b7a] sm:text-sm">
                Tell us what you need, how many stands you'd like to order, or ask us any questions about ChitraTap.</p>
            </div>
          ...
          <div className="mt-5 flex flex-col gap-4 border-t border-[#edf0f4] pt-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col items-start gap-3 sm:items-end">
              <button
                ...
                className="inline-flex h-11 min-w-[200px] items-center justify-center gap-2 rounded-full bg-brand px-5 text-xs font-bold text-white shadow-brand transition hover:bg-brand-deep disabled:cursor-not-allowed disabled:opacity-70"
              >
